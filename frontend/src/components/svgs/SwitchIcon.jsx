...
export function SwitchIcon({color, additionalClassNames}) {
	return <svg className={additionalClassNames} fill={color} xmlns="http://www.w3.org/2000/svg" id="mdi-nintendo-switch" viewBox="0 0 24 24">
		<path
